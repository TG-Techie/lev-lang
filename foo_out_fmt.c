...
typedef int8 content_int8;
content_int8 contentof_int8(int8 self) { return self; }
int8 litrl_int8(int8_t val) { return (int8){val}; }
int8 get_int8(int8 self) { return self; }
void rel_int8(int8 self) { return; }
int8 dec_dflt_int8() { return (int8){0}; }
int8 ret_int8(int8 self) { return self; }
typedef struct int16 {
  int16_t native;
} int16;
typedef int16 content_int16;
content_int16 contentof_int16(int16 self) { return self; }
int16 litrl_int16(int16_t val) { return (int16){val}; }
int16 get_int16(int16 self) { return self; }
void rel_int16(int16 self) { return; }
int16 dec_dflt_int16() { return (int16){0}; }
int16 ret_int16(int16 self) { return self; }
typedef struct int32 {
  int32_t native;
} int32;
typedef int32 content_int32;
content_int32 contentof_int32(int32 self) { return self; }
int32 litrl_int32(int32_t val) { return (int32){val}; }
int32 get_int32(int32 self) { return self; }
void rel_int32(int32 self) { return; }
int32 dec_dflt_int32() { return (int32){0}; }
int32 ret_int32(int32 self) { return self; }
typedef struct int64 {
  int64_t native;
} int64;
typedef int64 content_int64;
content_int64 contentof_int64(int64 self) { return self; }
int64 litrl_int64(int64_t val) { return (int64){val}; }
int64 get_int64(int64 self) { return self; }
void rel_int64(int64 self) { return; }
int64 dec_dflt_int64() { return (int64){0}; }
int64 ret_int64(int64 self) { return self; }

typedef struct uint8 {
  uint8_t native;
} uint8;
typedef uint8 content_uint8;
content_uint8 contentof_uint8(uint8 self) { return self; }
uint8 litrl_uint8(uint8_t val) { return (uint8){val}; }
uint8 get_uint8(uint8 self) { return self; }
void rel_uint8(uint8 self) { return; }
uint8 dec_dflt_uint8() { return (uint8){0}; }
uint8 ret_uint8(uint8 self) { return self; }
typedef struct uint16 {
  uint16_t native;
} uint16;
typedef uint16 content_uint16;
content_uint16 contentof_uint16(uint16 self) { return self; }
uint16 litrl_uint16(uint16_t val) { return (uint16){val}; }
uint16 get_uint16(uint16 self) { return self; }
void rel_uint16(uint16 self) { return; }
uint16 dec_dflt_uint16() { return (uint16){0}; }
uint16 ret_uint16(uint16 self) { return self; }
typedef struct uint32 {
  uint32_t native;
} uint32;
typedef uint32 content_uint32;
content_uint32 contentof_uint32(uint32 self) { return self; }
uint32 litrl_uint32(uint32_t val) { return (uint32){val}; }
uint32 get_uint32(uint32 self) { return self; }
void rel_uint32(uint32 self) { return; }
uint32 dec_dflt_uint32() { return (uint32){0}; }
uint32 ret_uint32(uint32 self) { return self; }
typedef struct uint64 {
  uint64_t native;
} uint64;
typedef uint64 content_uint64;
content_uint64 contentof_uint64(uint64 self) { return self; }
uint64 litrl_uint64(uint64_t val) { return (uint64){val}; }
uint64 get_uint64(uint64 self) { return self; }
void rel_uint64(uint64 self) { return; }
uint64 dec_dflt_uint64() { return (uint64){0}; }
uint64 ret_uint64(uint64 self) { return self; }

typedef struct float32 {
  float native;
} float32;
typedef float32 content_float32;
content_float32 contentof_float32(float32 self) { return self; }
float32 litrl_float32(float val) { return (float32){val}; }
float32 get_float32(float32 self) { return self; }
void rel_float32(float32 self) { return; }
float32 dec_dflt_float32() { return (float32){0}; }
float32 ret_float32(float32 self) { return self; }
typedef struct float64 {
  double native;
} float64;
typedef float64 content_float64;
content_float64 contentof_float64(float64 self) { return self; }
float64 litrl_float64(double val) { return (float64){val}; }
float64 get_float64(float64 self) { return self; }
void rel_float64(float64 self) { return; }
float64 dec_dflt_float64() { return (float64){0}; }
float64 ret_float64(float64 self) { return self; }
# 3 "compile_basic_levir.c" 2

# 1 "./methodtest.levir" 1
typedef struct content_RefdNum {
  int16 mbr_num;
} content_RefdNum;
typedef struct RefdNum {
  RefCount rc;
  content_RefdNum content;
} * RefdNum;
RefdNum new_RefdNum(content_RefdNum content) {
  RefdNum self = malloc(sizeof(struct RefdNum));
  self->rc = 1;
  self->content = content;
  return self;
}
RefdNum get_RefdNum(RefdNum self) {
  if (self == ((void *)0)) {
...
void rel_RefdNum(RefdNum self) {
  if (self == ((void *)0)) {
    return;
  }
  self->rc -= 1;
  if (self->rc == 0) {
    rel_int16(self->content.mbr_num);
    free(self);
  }
  return;
}
RefdNum dec_dflt_RefdNum() { return ((void *)0); }
RefdNum ret_RefdNum(RefdNum self) { return self; }
content_RefdNum *content_ptr_RefdNum(RefdNum *self_ptr) {
  RefdNum self = *self_ptr;
  return &(self->content);
}

typedef struct content_ClsWith2Mbrs {
  int16 mbr_a;
  int16 mbr_b;
} content_ClsWith2Mbrs;
typedef struct ClsWith2Mbrs {
  RefCount rc;
  content_ClsWith2Mbrs content;
} * ClsWith2Mbrs;
ClsWith2Mbrs new_ClsWith2Mbrs(content_ClsWith2Mbrs content) {
  ClsWith2Mbrs self = malloc(sizeof(struct ClsWith2Mbrs));
  self->rc = 1;
  self->content = content;
  return self;
}
ClsWith2Mbrs get_ClsWith2Mbrs(ClsWith2Mbrs self) {
  if (self == ((void *)0)) {
    printf("local variable used before assignment\n");
    *((void *)0);
  }
...
void rel_ClsWith2Mbrs(ClsWith2Mbrs self) {
  if (self == ((void *)0)) {
    return;
  }
  self->rc -= 1;
  if (self->rc == 0) {
    rel_int16(self->content.mbr_a);
    rel_int16(self->content.mbr_b);
    free(self);
  }
  return;
}
ClsWith2Mbrs dec_dflt_ClsWith2Mbrs() { return ((void *)0); }
ClsWith2Mbrs ret_ClsWith2Mbrs(ClsWith2Mbrs self) { return self; }
content_ClsWith2Mbrs *content_ptr_ClsWith2Mbrs(ClsWith2Mbrs *self_ptr) {
  ClsWith2Mbrs self = *self_ptr;
  return &(self->content);
}
...
typedef LinkedPoint content_LinkedPoint;
LinkedPoint new_LinkedPoint(content_LinkedPoint content) { return content; }
LinkedPoint get_LinkedPoint(LinkedPoint self) {
  return (LinkedPoint){
      get_RefdNum(self.mbr__x),
      get_RefdNum(self.mbr__y),
  };
}
void rel_LinkedPoint(LinkedPoint self) {
  rel_RefdNum(self.mbr__x);
  rel_RefdNum(self.mbr__y);
  return;
}
LinkedPoint dec_dflt_LinkedPoint() {
  return (LinkedPoint){
      dec_dflt_RefdNum(),
      dec_dflt_RefdNum(),
  };
}
LinkedPoint ret_LinkedPoint(LinkedPoint self) { return self; }
content_LinkedPoint *content_ptr_LinkedPoint(LinkedPoint *self_ptr) {
  return (content_LinkedPoint *)self_ptr;
}
typedef LinkedPoint *mutble_proxy_LinkedPoint;
mutble_proxy_LinkedPoint
get_mutble_proxy_LinkedPoint(mutble_proxy_LinkedPoint self) {
  get_LinkedPoint(*self);
  return self;
}
void rel_mutble_proxy_LinkedPoint(mutble_proxy_LinkedPoint self) {
  return rel_LinkedPoint(*self);
}
mutble_proxy_LinkedPoint dec_dflt_mutble_proxy_LinkedPoint() {
  return ((void *)0);
}
LinkedPoint ret_mutble_proxy_LinkedPoint(mutble_proxy_LinkedPoint self) {
  return *self;
}
content_LinkedPoint *
content_ptr_mutble_proxy_LinkedPoint(mutble_proxy_LinkedPoint *self_ptr) {
  mutble_proxy_LinkedPoint self = *self_ptr;
  return (content_LinkedPoint *)self;
}
mutble_proxy_LinkedPoint
proxy_mutble_proxy_LinkedPoint(mutble_proxy_LinkedPoint *self_ptr) {
  return *self_ptr;
}
mutble_proxy_LinkedPoint proxy_LinkedPoint(LinkedPoint *self) {
  return (mutble_proxy_LinkedPoint)self;
}
# 24 "./methodtest.levir"
int16 fn_main(void) {
  LinkedPoint var_point = dec_dflt_LinkedPoint();
  RefdNum var_foo = dec_dflt_RefdNum();
  ClsWith2Mbrs var_newtest = dec_dflt_ClsWith2Mbrs();
  ("test new method of making new objects", "the one w/ cntn 'content'");
  {
    ClsWith2Mbrs *target_ptr = &(var_newtest);
    ClsWith2Mbrs prev_value = *target_ptr;
    *target_ptr = new_ClsWith2Mbrs((content_ClsWith2Mbrs){
        litrl_int16(127),
        litrl_int16(255),
    });
    rel_ClsWith2Mbrs(prev_value);
  }
  {
    ("dbg(rc(", "var(foo, RefdNum)", "))");
    if (var_foo == ((void *)0)) {
      printf("unable to get rc of `"
             "var(foo, RefdNum)"
             "`, not yet assigned\n");
    } else {
      printf("rc of `"
  ...
  {
    LinkedPoint *target_ptr = &(var_point);
    LinkedPoint prev_value = *target_ptr;
    *target_ptr = new_LinkedPoint(
        (content_LinkedPoint){new (RefdNum, cntn(litrl_int16(127))),
                              new (RefdNum, cntn(litrl_int16(127)))});
    rel_LinkedPoint(prev_value);
  }
  int16 _return_tmp_ = litrl_int16(0);
  goto _return_label_;
_return_label_:
  rel_LinkedPoint(var_point);
  rel_RefdNum(var_foo);
  rel_ClsWith2Mbrs(var_newtest);
  return _return_tmp_;
}
